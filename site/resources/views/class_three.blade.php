            ...
            <form action="class_three_save" method="post">
                ...
                <div class="student_info1">
                    <div class="table_heading">
                        <span> <h5 class="font-weight-bold" style="background-color:#4dc0b5; padding: 10px"> ৯.৪ শিক্ষার্থী সংক্রান্ত: <span style="font-size: 18px; font-weight: normal">তৃতীয় শ্রেণি </span></h5></span>
                    </div>

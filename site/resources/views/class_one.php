...
<div class="container kalpurus" id="app">
    ...
    <div class="topnav">
        ...
        <a href="#" class="active">প্রথম শ্রেণি</a>
            ...
            <form class="form-group">
                <div class="student_info1">
                    <div class="table_heading">
                        <span> <h5 class="font-weight-bold" style="background-color:#4dc0b5; padding: 10px"> ৯. শিক্ষার্থী সংক্রান্ত: প্রথম শ্রেণি</h5></span>
                    </div>

...
<div class="container kalpurus" id="app">
    ...
    <div class="first_body">
        <div class="student_info border" style="padding:10px; font-size:14px">
            <form action="class_five_save" method="post">
                {{ csrf_field()}}
                <div class="student_info1">
                    <div class="table_heading">
                        <span> <h5 class="font-weight-bold" style="background-color:#4dc0b5; padding: 10px"> ৯.৬ শিক্ষার্থী সংক্রান্ত: <span style="font-size: 18px; font-weight: normal">পঞ্চম শ্রেণি </span></h5></span>
                    </div>

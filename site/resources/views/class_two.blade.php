...
<div class="container kalpurus" id="app">
    ...
    <div class="first_body">
        <div class="student_info border" style="padding:10px; font-size:14px">
            <form action="class_two_save" method="post">
                {{ csrf_field()}}
                <div class="student_info1">
                    <div class="table_heading">
                        <span> <h5 class="font-weight-bold" style="background-color:#4dc0b5; padding: 10px"> ৯.৩ শিক্ষার্থী সংক্রান্ত: <span style="font-size: 18px; font-weight: normal">দ্বিতীয় শ্রেণি </span></h5></span>
                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th colspan="4" style="text-align: center">২০২২ সালে একই শ্রেণিতে
                                            অধ্যয়ন <br>
                                            (২০২২ সালের শিক্ষার্থীদের মধ্যে কতজন একই শ্রেণিতে অধ্যয়ন/রিরপিট করছে)
                                        </th>
                                    </tr>
                                    <tr>

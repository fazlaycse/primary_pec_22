...
<div class="student_info border" style="padding:10px; font-size:14px">
                    <div class="student_info1">
                        <div class="table_heading">
                            <span> <h5 class="font-weight-bold" style="background-color:#4dc0b5; padding: 10px"> ৯.১ শিক্ষার্থী সংক্রান্ত: প্রাক প্রাথমিক <span style="font-size: 18px; font-weight: normal">প্রাক-প্রাথমিক শ্রেণি</span></h5></span>
                        </div>

...
<div class="container" id="app">
    ...
    <div class="form_name">
        <div class="heading col-md-12">
            <h6 style="text-align:center"> বার্ষিক প্রাথমিক বিদ্যালয় শুমারি-২০২০ এর পিইসি তথ্য সংগ্রহ ফরম <h6>
        </div>
    </div>
    <hr>
    <div class="topnav">
        ...
        <a href="#">চতুর্থ পাতা</a>
            ...
            <div class="pull-right">
                <a href="third_page"> <button type="button" class="btn btn-primary btn-lg" style="text-align:right; margin-top:20px">Next Page</button></a>

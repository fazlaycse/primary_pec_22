...
class ClassFourController extends Controller
{
    public function read(Request $request)
    {
        ...
        try {
            $row = Ethnic_student::where('institute_id', '=', $request->session()->get('institute_id'))->where('class_id', '=', 4)->firstOrFail();
            //print_r($row);die;
        ...
        try {
            $row = Special_students::where('institute_id', '=', $request->session()->get('institute_id'))->where('class_id', '=', 4)->firstOrFail();
            //print_r($row); exit;
            array_push($instRow, $row);
        } catch (\Exception $e) {
            // do task when error
        ...
        try {
            $row = Classwise_students::where('institute_id', '=', $request->session()->get('institute_id'))->where('class_id', '=', 4)->firstOrFail();
            array_push($instRow, $row);
        } catch (\Exception $e) {
            // do task when error
        ...
        try {
            $row = Repeater_students::where('institute_id', '=', $request->session()->get('institute_id'))->where('class_id', '=', 4)->firstOrFail();
            array_push($instRow, $row);
        } catch (\Exception $e) {
            // do task when error
        ...
        return view('class_four')->with('instRowObj',$instRowObj);
    ...
    public function updateOrcreate(Request $request)
    {
        if ($request->method() == 'POST') {
            ...
            try {
                $updateOrcreateRow = Ethnic_student::updateOrCreate(['institute_id' => $request->session()->get('institute_id'),'class_id'=>4], $request->all());
            } catch (\Exception $e) {
                echo $e->getMessage();
            ...
            try {
                ...
                $updateOrcreateRow = Special_students::updateOrCreate(['institute_id' => $request->session()->get('institute_id'),'class_id'=>4], $request->all());
            } catch (\Exception $e) {
                echo $e->getMessage();
            ...
            try {
                $updateOrcreateRow = Classwise_students::updateOrCreate(['institute_id' => $request->session()->get('institute_id'),'class_id'=>4], $request->all());
            } catch (\Exception $e) {
                echo $e->getMessage();
            ...
            try {
                $updateOrcreateRow = repeater_students::updateOrCreate(['institute_id' => $request->session()->get('institute_id'),'class_id'=>4], $request->all());
